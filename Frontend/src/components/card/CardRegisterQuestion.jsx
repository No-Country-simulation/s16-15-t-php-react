    ...
    <div id="div-card">
        <div id="div-card1" onClick={() => handleOptionChange('client')} className={selectedOption === 'client' ? 'selected' : ''}>
            ...
            <div className="div-radio">
                <input type="radio" checked={selectedOption === 'client'} onChange={() => handleOptionChange('client')}/>
            </div>
        </div>
        <div id="div-card2" onClick={() => handleOptionChange('freelancer')} className={selectedOption === 'freelancer' ? 'selected' : ''}>
            ...
            <div className="div-radio">
                <input type="radio" checked={selectedOption === 'freelancer'} onChange={() => handleOptionChange('freelancer')}/>
            </div>
        </div>        
    </div>
  );
